...
public interface UserService {
    ...
    ServiceResponse<User> login(String login, CharSequence password, Locale locale) throws ServiceException;
    ...
    ServiceResponse<Boolean> deleteUserAccountByAdministration(int userId) throws ServiceException;
