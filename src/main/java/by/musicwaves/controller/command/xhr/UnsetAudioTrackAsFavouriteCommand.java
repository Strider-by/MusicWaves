...
public class UnsetAudioTrackAsFavouriteCommand extends AbstractXHRCommand {

    private static final Logger LOGGER = LogManager.getLogger(UnsetAudioTrackAsFavouriteCommand.class);
    private static final CrossEntityService service = ServiceFactory.getInstance().getCrossEntityService();
    private static final String PARAM_NAME_TRACK_ID = "track_id";

    public UnsetAudioTrackAsFavouriteCommand(AccessLevel accessLevel) {
        super(accessLevel);
    }
