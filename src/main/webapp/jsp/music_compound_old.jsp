...
<head>
    <title id="page_title">
        change_me:
        change_me</title>
    <link type="text/css" rel="stylesheet" href="../static/old/music_compound_general.css"/>
    <link type="text/css" rel="stylesheet" href="../static/old/music_compound_tabs.css"/>
    <link type="text/css" rel="stylesheet" href="../static/old/access_denied_msg_box.css"/>
    <link type="text/css" rel="stylesheet" href="../static/old/messages.css"/>
    <link rel="icon" type="image/png" href="../static/images/favicon-200x200.png" sizes="200x200">
    <script src="../static/old/long-press.js" charset="utf-8"></script>
    <script src="../static/old/messages.js" charset="utf-8"></script>
    <script src="../static/old/music_compound.js" charset="utf-8"></script>
    <script src="../static/old/music_compound_artists.js" charset="utf-8"></script>
    <script src="../static/old/music_compound_albums.js" charset="utf-8"></script>
    <script src="../static/old/music_compound_tracks.js" charset="utf-8"></script>
    <script>
        window.labels = {};
                ...
                <div id="artists_tab_window" class="">
                    <div class="flex">
                        ...
                        <div class="databox">
                            ...
                            <%-- EDIT ARTIST AREA --%>
                            <div class="edit_instance_area " id="edit_artist_area">
                                <div class="area_inner_header">
                                    change_me
                                </div>
                                <div class="indiv">
